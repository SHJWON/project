...
<html>
	...
	<body>
		...
		<hr>
			...
			<a href="<c:url value='/imageFileUploadForm'/>">이미지파일 업로드 </a><br/>
			<a href="<c:url value='/audioFileUploadForm'/>">오디오파일 업로드 </a><br/>
			<a href="<c:url value='/recordFileUploadForm'/>">녹음파일 업로드 </a><br/>
